...
import type { BankDetails as _BankDetails, DataPlan as _DataPlan, StripeSessionStatus as _StripeSessionStatus, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addDataPlan(arg0: string, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addDataPlan(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createSinglePlanCheckoutSession(arg0: string, arg1: string, arg2: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createSinglePlanCheckoutSession(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllDataPlans(): Promise<Array<DataPlan>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllDataPlans();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDataPlan(arg0: string): Promise<DataPlan | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getDataPlan(arg0);
    ...
    async highestToLowestPrice(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.highestToLowestPrice();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_BankDetails_n4(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _BankDetails): BankDetails {
...
function from_candid_opt_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_DataPlan]): DataPlan | null {
...
function from_candid_record_n5(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        bic: record_opt_to_undefined(from_candid_opt_n6(_uploadFile, _downloadFile, value.bic)),
        iban: record_opt_to_undefined(from_candid_opt_n6(_uploadFile, _downloadFile, value.iban)),
...
function to_candid_record_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        bic: value.bic ? candid_some(value.bic) : candid_none(),
        iban: value.iban ? candid_some(value.iban) : candid_none(),
